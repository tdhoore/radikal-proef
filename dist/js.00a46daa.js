...
},{}],"js/helpers/ajax.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fetchPostJsonAPI = exports.fetchPostAPI = exports.fetchAPI = void 0;

var fetchAPI = function fetchAPI(url) {
  return fetch("".concat("http://localhost/").concat(url)).then(function (r) {
    return r.json();
  });
};
...
var fetchPostAPI = function fetchPostAPI() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    url: url,
    formData: formData,
    method: "POST"
  };
  return fetch("".concat("http://localhost/").concat(params.url), {
...
exports.fetchPostAPI = fetchPostAPI;

var fetchPostJsonAPI = function fetchPostJsonAPI() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    url: url,
    json: json,
    method: "POST"
...
exports.fetchPostJsonAPI = fetchPostJsonAPI;
...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/classes/FilterPage.js":[function(require,module,exports) {
"use strict";
...
var _ajax = require("../helpers/ajax");
...
function () {
  function FilterPage() {
    ...
    this.postUrl = ""; //animations

    this.removeProducts = _gsap.default.to(this.productSelector, {
      y: 100,
      opacity: 0,
      duration: 0.3,
      ease: "power2.out",
  ...
  _createClass(FilterPage, [{
    ...
    value: function init() {
      ...
      if (this.form && this.productsHolder) {
        ...
        this.form.addEventListener("submit", function (e) {
          return _this.handleSubmitForm(e);
        });
      }
    }
  }, {
    ...
    value: function handleSubmitForm(e) {
      e.preventDefault();
      var data = new FormData(); //dit is de functe om een post request te doen naar de server maar omdat die er niet is gaan we het faken
    ...
    value: function updateproducts() {
      ...
      var products = this.productsHolder.querySelectorAll(this.productSelector);
      this.removeProducts.restart();
      this.removeProducts.play(); //fake loading new items

      setTimeout(function () {
        _gsap.default.fromTo(_this2.productSelector, {
          y: -100,
          opacity: 0
        }, {
          y: 0,
...
},{"../helpers/ajax":"js/helpers/ajax.js","gsap":"../node_modules/gsap/index.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
var _FilterPage = _interopRequireDefault(require("./classes/FilterPage"));
...
var init = function init() {
  ...
  clearFilter.init();
  var filterPage = new _FilterPage.default({
    formSelector: ".filterHolder",
...
init();
},{"../css/index.scss":"css/index.scss","./classes/HamburgerNav":"js/classes/HamburgerNav.js","./classes/StarRating":"js/classes/StarRating.js","./classes/ClearForm":"js/classes/ClearForm.js","./classes/FilterPage":"js/classes/FilterPage.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
